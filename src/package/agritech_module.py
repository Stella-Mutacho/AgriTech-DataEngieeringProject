...
def read_text(text_path):
    '''
    Defines a function to read region names fromm the regions text file
    params:
        text file path
    '''
    text = []
...
class Lidar():
    """
    This class can be used to connect to  USGS 3DEP dataset available to the public on AWS cloud and fetch the data, with functions to load the data 
    ...
    def __init__(self, coordinates, region):
        ...
        self.url = "https://s3-us-west-2.amazonaws.com/usgs-lidar-public"   # public path
        self.region = region  # the region to explore
    ...
    def generate_polygon(self, coor, epsg):
        """
        Define function that generates a GPS coordinates polygon from the list of coordinates
        params:
    ...
    def get_geoDf(self, pipe, epsg):
        """
        Define a function to generate a Geo Dataframe after executing the pdal pipeline
        params:
